...
export const menuSeedDefs: MenuSeedNode[] = [
  ...
  { type: "menu", name: "模型展厅", path: "/exhibit", icon: "icon-camera", sort: 6 },
  { type: "menu", name: "成长记录", path: "/growth", icon: "icon-miles", sort: 7 },
  { type: "menu", name: "健康档案", path: "/health", icon: "icon-variant", sort: 8 },
  { type: "menu", name: "时光相册", path: "/moments", icon: "icon-camera", sort: 9 },
  { type: "menu", name: "账单", path: "/bills", icon: "icon-shopping", sort: 10 },
  { type: "menu", name: "卡证档案", path: "/certs", icon: "icon-variant", sort: 11 },
  { type: "menu", name: "提醒中心", path: "/reminders", icon: "icon-miles", sort: 12 },
  { type: "menu", name: "政策动态", path: "/policies", icon: "icon-chat", sort: 13 },
